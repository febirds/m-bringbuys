...
public class ActionEnter {
    ...
    public ActionEnter(HttpServletRequest request, String rootPath) {
        ...
        this.prePath = "/upload/" + MD5.GetMD5Code(user.getUserName() == null ? "public" : user.getUserName());
        this.configManager = ConfigManager.getInstance(this.prePath, this.rootPath, this.contextPath, request.getRequestURI());
    }
